...
function deleteRow(index) {
  ...
  localStorage.setItem('mahasiswaData', JSON.stringify(data)); // Perbarui data di local storage
...
let editIndex = null; // Menyimpan indeks data yang diedit
...
function editRow(index) {
  ...
  // Hapus event listener dari tombol save sebelum menambahkannya kembali
...
function saveEditData() {
  ...
  // Reset editIndex setelah penyimpanan selesai
  editIndex = null;
}
